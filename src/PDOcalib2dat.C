...
int main(int argc, char* argv[]) {
  ...
  if ( argc < 2 ){
    ...
    cout << " contains PDOcalib tree" << endl;
    cout << "Example:   ./PDOcalib2dat input_file.root" << endl;
    cout << "Example:   ./PDOcalib2dat input_file.root -o output_file.dat" << endl;
    return 1;
  }
  ...
  PDOToCharge PDO2Charge(inputFileName);
  PDO2Charge.PrintToFile(outputFileName);
