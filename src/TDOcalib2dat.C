...
int main(int argc, char* argv[]) {
  ...
  if ( argc < 2 ){
    ...
    cout << " contains TDOcalib tree" << endl;
    cout << "Example:   ./TDOcalib2dat input_file.root" << endl;
    cout << "Example:   ./TDOcalib2dat input_file.root -o output_file.dat" << endl;
    return 1;
  }
  ...
  TDOToTime TDO2Time(inputFileName);
  TDO2Time.PrintToFile(outputFileName);
